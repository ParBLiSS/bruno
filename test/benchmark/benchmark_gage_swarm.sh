...
# warm up.
mpirun_rsh -hostfile=$PBS_NODEFILE -np $p ${BINDIR}/bin/compact_debruijn_graph_fastq_A4_K31_freq_incr -R -B -T -L 4 -O ${OUTDIR}/${DATASET}_A4_K31_L4_P${p}_freq $DATA > ${OUTDIR}/warmup${DATASET}_A4_K31_L4_P${p}_freq.dummy 2>&1
rm ${OUTDIR}/${DATASET}_A4_K31_L4_P${p}_freq*
