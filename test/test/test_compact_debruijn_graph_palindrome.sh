...
# run the experiments.
for exp in "_freq" "" "_freq_minimizer" "_incr" "_freq_incr" "_freq_incr_minimizer"
do
...
for suf in ".0.valid" ".0.valid.debug" "_branch.fasta" "_branch.edges" "_chain.components" "_chain.fasta" "_chain.edges" "_compressed_chain.debug"
do
	diff a4_k31_freq_chr14_pal_L${t}.p${1}${suf} a4_k31_freq${exp}_chr14_pal_L${t}.p${1}${suf} > a4_k31_freq_vs${exp}_chr14_pal_L${t}.p${1}${suf}.diff
done
done
