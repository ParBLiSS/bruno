...
::std::vector<::bliss::io::mapped_data> open_mmaps(std::vector<std::string> const & filenames, mxx::comm const & comm) {
	::std::vector<::bliss::io::mapped_data> file_data;
...
//#endif
  ...
  bool mmap = false;
    ...
    TCLAP::SwitchArg mmapArg("M", "memmap", "on - use memmap for input.  off - use posix io", cmd, false);
...
//#endif
  ...
  // ================  read and get file
  BL_BENCH_START(app);
  ::std::vector<::bliss::io::file_data> file_data = open_files(filenames, comm, mmap);
