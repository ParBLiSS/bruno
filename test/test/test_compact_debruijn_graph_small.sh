...
do
	mpirun -np ${1} bin/compact_debruijn_graph_fastq_A4_K31${exp} -R -C -T -L ${t} -O a4_k31${exp}_palchr14_L${t}.p${1} $DATA 2>&1 | tee a4_k31${exp}_palchr14_L${t}.p${1}.log
done
...
do
	...
	do
		diff a4_k31${exp}_palchr14_L${t}.p${1}${suf} a4_k31_palchr14_L${t}.p${1}${suf} > a4_k31${exp}_palchr14_L${t}.p${1}${suf}.diff
	done
done
