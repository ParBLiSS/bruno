  ...
  namespace common
  {
    ...
    class Sequence
    {
      public:
        ...
        bool is_record_truncated_at_begin() const { return seq_begin_offset > seq_offset; }
        bool is_record_truncated_at_end() const { return seq_begin_offset + seq_size() < record_size; }
