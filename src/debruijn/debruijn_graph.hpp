...
//
//	template <typename KmerType, typename FreqValueType>
//	class chained_debruijn_graph;
//
//	/**
//	 * @brief a debruijn graph with its chains stored separately, and ordered via list ranking.
//	 *
//	 */
//	template <typename KmerType>
//	class chained_debruijn_graph<KmerType, bool> : public debruijn_graph<KmerType, bool> {
//
//	public:
//		template <typename KMER>
//		using map_params_template = ::bliss::debruijn::CanonicalDeBruijnHashMapParams<KMER>;
//		using map_params_type =
//				::bliss::debruijn::CanonicalDeBruijnHashMapParams<KmerType>;
//
//		// full debruijn graph map - with or without frequency
//		using map_type =
//				::bliss::debruijn::graph::debruijn_graph_map<KmerType,
...
//				  map_params_template>;
//
//		using chain_map_type = ::dsc::densehash_map<KmerType,
...
//
//	public:
//		/// can only construct from full debruijn graph
//		chained_debruijn_graph(debruijn_graph<KmerType, bool> const & graph) {
//
//		}
//
//		/// can only construct from full debruijn graph
//		chained_debruijn_graph(debruijn_graph<KmerType, bool> && graph) {
//
//		}
//
//		/// get internal branch map
//		map_type & get_branch_map() { return branches; }
//		map_type const & get_branch_map() const { return branches; }
//
//		/// get internal chain map
//		map_type & get_chain_map() { return chains; }
//		map_type const & get_chain_map() const { return chains; }
//
//
